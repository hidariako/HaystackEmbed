 ...
 * This file demonstrates how to integrate Haystackembed with a web frontend
 */

// For React/Vue/Angular applications
export class HaystackembedClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new HaystackembedClient(provider, contractAddress);
