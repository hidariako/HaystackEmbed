...
const contractABI = require("../artifacts/contracts/Haystackembed.sol/Haystackembed.json").abi;

program
    .name("haystackembed-cli")
    .description("CLI tool for Haystackembed smart contract")
    .version("1.0.0");
